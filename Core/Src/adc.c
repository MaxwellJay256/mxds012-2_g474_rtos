...
void MX_ADC5_Init(void)
{
  ...
  */
  hadc5.Instance = ADC5;
  hadc5.Init.ClockPrescaler = ADC_CLOCK_ASYNC_DIV2;
  hadc5.Init.Resolution = ADC_RESOLUTION_10B;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    */
    ...
    /* ADC3 DMA Init */
    /* ADC3 Init */
    hdma_adc3.Instance = DMA2_Channel2;
  ...
  */
    ...
    PA8     ------> ADC5_IN1
    */
    GPIO_InitStruct.Pin = ADC_CHREF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_CHREF_GPIO_Port, &GPIO_InitStruct);

    /* ADC5 DMA Init */
    /* ADC5 Init */
    hdma_adc5.Instance = DMA2_Channel1;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(ADC_CH3_GPIO_Port, ADC_CH3_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(ADC_CH4_GPIO_Port, ADC_CH4_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA8     ------> ADC5_IN1
    */
    HAL_GPIO_DeInit(ADC_CHREF_GPIO_Port, ADC_CHREF_Pin);
